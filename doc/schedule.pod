...
C<out>, C<venue>, C<r1>, C<r2> and C<r3>. (If you have four rooms, a
style C<r4> will automatically be used, and so on.)

You can either define those styles in you stylesheet, or simply load the
...
B<WARNING:> The schedule layout will be completely broken if you have
any event that ends after midnight. This is a low priority I<known bug>.
Until it's fixed, B<do not configure any talk or event to end after midnight!>
