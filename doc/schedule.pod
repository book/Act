...
C<out>, C<venue>, C<r1>, C<r2> and C<r3>. Please note that you do not need to define
your own CSS for this: simply load the style located at F</css/schedule.css>
with C<E<lt>link rel="stylesheet" type="text/css" href="/css/schedule.css" /E<gt>>.
