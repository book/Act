...
E<lt>headE<gt> section of your pages, for example in your C<ui> template:
  ...
  <link rel="alternate" type="application/atom+xml" title="[% global.conference.name %]" href="http://domain/conf_id/news.xml" />
