...
for under the paths C<"$ACTHOME/$conference/actdocs/conf/act.ini"> and
C<"$ACTHOME/$conference/actdocs/conf/local.ini">.  This allows to have
all files provided by a conference under one directory
C<"$ACTHOME/$conference/">, in a layout equal to that of a conference
